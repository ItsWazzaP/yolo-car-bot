...
async def main():
    start_server = await websockets.serve(
        handle_client,
        "0.0.0.0",  # Slušaj na svim interfejsima
        1606,
        ping_interval=60,  # Šalji ping svakih 60 sekundi
        ping_timeout=30    # Čekaj 30 sekundi na pong pre nego što prekineš konekciju
    )
